...
function loadTickets() {
  let allTickets = myDB.getItem("allTickets");           //property of localStorage to get item from it
  if(allTickets) {                                       //allTickets is a place where all tickets reside
...
function saveTicketToDB(ticketInfoObject) {
  ...
  if (allTickets) {
    ...
    myDB.setItem("allTickets", JSON.stringify(allTickets));     //property of localStorage to set item in it
  } else {
